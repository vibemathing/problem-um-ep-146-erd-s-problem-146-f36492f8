...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-146-erd-s-problem-146-f36492f8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-146"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-146-erd-s-problem-146-f36492f8-v1",
      "problem_contract_sha256": "3a20f967a1e9b048386c3016d02af527fa8dc9731d040f5ecbca98381e08d210",
      "problem_id": "problem:um-ep-146-erd-s-problem-146-f36492f8",
      "route_id": "route:um-ep-146-erd-s-problem-146-f36492f8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-146-erd-s-problem-146-f36492f8-source-fidelity-01",
      "graph_id": "graph:um-ep-146-erd-s-problem-146-f36492f8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-146-erd-s-problem-146-f36492f8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-146-erd-s-problem-146-f36492f8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If $H$ is bipartite and is $r$-degenerate, that is, every induced subgraph of $H$ has minimum degree $\\leq r$, then $ \\mathrm{ex}(n;H) \\ll n^{2-1/r}. $"
          },
          "statement_sha256": "f3e4492c44a81ed1efb0039cd3a982e4cf793ad0f12c354a2a6c7a53d341b7f3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-146-erd-s-problem-146-f36492f8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-146-erd-s-problem-146-f36492f8-root",
      "route_id": "route:um-ep-146-erd-s-problem-146-f36492f8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-146-7bf7b4482fdb",
        "url": "https://www.unsolvedmath.com/problems/EP-146"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
